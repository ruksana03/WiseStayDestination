...
//     <Carousel showArrows={true} autoPlay={true} interval={5000}>
//       {imageUrls && imageUrls.length > 0 && imageUrls.map((hotelImg, index) => (
//         <div key={index}>
//           <figure>
//             <img src={imageUrls[index]} className="max-h-[200px]" alt={`Image ${index}`} />
//           </figure>

//           {/* <img src={hotelImg} alt={`Image ${index + 1}`} /> */}
//         </div>
//       ))}
//     </Carousel>
//   </div>
...
//     <Carousel showArrows={true} autoPlay={true} interval={5000}>
//       {imageUrls.length > 0 &&
//         imageUrls.map((hotelimg) =><img src={hotelimg} alt="" />)}
//     </Carousel>
//   </div>
//   <div className="col-span-6"></div>
//   <div className="col-span-2"></div>
{/* <figure>
                    <img src={} className="max-h-[200px]" alt="Album" /></figure>
                <div className="card-body">
                    <h2 className="card-title">{name}</h2> */}
{/* <p>{Category}</p> */ }
{/* </div>
                <div className="card-actions flex flex-col justify-center">
                    <button onClick={() => handleDelete(_id)} className="btn btn-primary">Delete This room</button>
                    <button onClick={() => goto(`/dashboard/updateRoom/${_id}`)} className="btn btn-primary">Update This Recipies</button>
                </div> */}
// </div>
//   );
// };
