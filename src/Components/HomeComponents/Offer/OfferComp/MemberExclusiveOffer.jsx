...
const MemberExclusiveOffer = () => {
    return (
        <div className="hero w-full h-full py-10" style={{ backgroundImage: 'url(https://i.ibb.co/H2QqPm9/offer1.jpg)' }}>
...
export default MemberExclusiveOffer;